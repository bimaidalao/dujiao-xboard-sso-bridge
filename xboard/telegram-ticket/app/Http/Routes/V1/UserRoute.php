...
use App\Http\Controllers\V1\User\TicketMediaController;
...
class UserRoute
{
    public function map(Registrar $router)
    {
        $router->group([
            ...
            $router->post('/ticket/media/upload', [TicketMediaController::class, 'upload']);
            $router->get('/ticket/media/{id}', [TicketMediaController::class, 'show']);
            ...
            $router->post('/redeemgiftcard', [GiftCardController::class, 'redeem']);
